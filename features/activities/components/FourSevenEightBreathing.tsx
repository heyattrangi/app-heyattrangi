    ...
    <div style={styles.container}>
      ...
      {screen === "detail" && (
        <div style={styles.card}>
          ...
          <h1 style={styles.title}>4-7-8 Breathing</h1>
          <p style={styles.subtitle}>A calming breath pattern to ease anxiety and help you unwind.</p>

          <div style={styles.sectionHeader}>ABOUT THIS ACTIVITY</div>
          <p style={styles.aboutText}>
            Breathe in for 4 seconds, hold for 7, and exhale slowly for 8. The long exhale helps calm your nervous system quickly.
          </p>
          ...
          <button className="fse-btn" style={styles.beginBtn} onClick={handleBegin}>
            Begin
          </button>
        </div>
      )}
        ...
        <div style={styles.card}>
          <div style={styles.headerRow}>
            <div style={{ display: "flex", flexDirection: "column" }}>
              <span style={styles.cycleCounter}>Breath {cycle} of 4</span>
              <span style={styles.captionText}>Traditionally done for 4 rounds</span>
            </div>
          ...
          <div style={styles.controlsRow}>
            <button className="fse-btn" style={styles.secondaryBtn} onClick={handlePauseToggle}>
              {isPaused ? "Resume" : "Pause"}
            </button>
            <button className="fse-btn" style={styles.endBtn} onClick={handleEndEarly}>
              End Session
            </button>
          </div>
        </div>
        ...
        <div style={styles.card}>
          <div style={styles.completeContent}>
            ...
            <p style={styles.completeText}>
              You've completed 4 rounds of 4-7-8 breathing. Notice how your body feels now compared to when you started.
            </p>
            <div style={styles.completeButtons}>
              <button className="fse-btn" style={styles.secondaryBtn} onClick={handleDone}>
                Done
              </button>
              <button className="fse-btn" style={styles.primaryBtn} onClick={handleDoItAgain}>
                Do It Again
              </button>
            </div>
          </div>
